...
{
    public partial class NadoconDelfines : Form
    {
        ...
        public NadoconDelfines()
        {
            ...
            this.Load += NadoconDelfines_Load;
        }

        private void NadoconDelfines_Load(object sender, EventArgs e)
        {
            try
            {
